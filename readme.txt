FITUR YANG BISA DILAKUKAN ADMIN - ADD, EDIT, DELETE, DUPLICATE DATA, DAN DRAG AND DROP DATA CALENDER
1. ADD SCHEDULE
-Bisa menekan tombol +Add Schedule
...
3. DELETE
- Bisa langsung memilih data yang ingin dihapus dengan menekan langsung icon  ⚙️
4. DUPLICATE
...
- Bisa langsung memilih nama sesuai teachernya lalu Data akan muncul baik di data tabel ataupun di Calendar
2. VIEW IN CALENDAR
- Mempunyai 3 tombol untuk melihat data jadwal berdasarkan MONTH, LIST, dan WEEK
- Data jadwal pada kalender bisa ditekan, lalu akan muncul detail data jadwalnya
